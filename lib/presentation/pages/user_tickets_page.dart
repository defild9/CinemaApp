...
import 'package:cinema_app/presentation/blocs/user_tickets/user_tickets_bloc.dart';
import 'package:cinema_app/presentation/blocs/user_tickets/user_tickets_event.dart';
import 'package:cinema_app/presentation/widgets/custom_appbar.dart';
import 'package:cinema_app/presentation/widgets/ticket_card.dart';
...
//   Widget build(BuildContext context) {
//     return BlocProvider(
//       create: (context) => UserTicketsBloc()..add(FetchTicketsEvent()),
//       child: BlocBuilder<UserTicketsBloc, UserTicketsState>(
//         builder: (context, state) {
//           if (state is UserTicketsLoading) {
//             return const Center(child: CircularProgressIndicator());
