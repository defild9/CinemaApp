...
import 'package:cinema_app/presentation/widgets/custom_appbar_with_timer.dart';
import 'package:cinema_app/presentation/widgets/purchase_form.dart';
        ...
        body: BlocBuilder<PurchaseBloc, PurchaseState>(
          builder: (context, state) {
            if (state is PurchaseInProgress) {
              ...
              // Use addPostFrameCallback for delayed navigation
